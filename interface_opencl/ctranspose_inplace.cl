...
__kernel void ctranspose_inplace_even_kernel( __global magmaFloatComplex *matrix, int offset, int lda, int half_val )
{
...
__kernel void ctranspose_inplace_odd_kernel( __global magmaFloatComplex *matrix, int offset, int lda, int half_val )
{
    //__local magmaFloatComplex a[NB][NB+1];
    //__local magmaFloatComplex b[NB][NB+1];
