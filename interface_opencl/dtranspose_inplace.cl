...
__kernel void dtranspose_inplace_even_kernel( __global double *matrix, int offset, int lda, int half_val )
{
...
__kernel void dtranspose_inplace_odd_kernel( __global double *matrix, int offset, int lda, int half_val )
{
    //__local double a[NB][NB+1];
    //__local double b[NB][NB+1];
