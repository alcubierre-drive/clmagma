...
__kernel void stranspose_inplace_even_kernel( __global float *matrix, int offset, int lda, int half_val )
{
...
__kernel void stranspose_inplace_odd_kernel( __global float *matrix, int offset, int lda, int half_val )
{
    //__local float a[NB][NB+1];
    //__local float b[NB][NB+1];
